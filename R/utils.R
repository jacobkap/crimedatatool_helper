...
hate_crimes_offenses_fix <- c(
  "^arson$" = "arson",
  "^assault offenses - aggravated assault$" = "violent",
  "^assault offenses - intimidation$" = "violent",
  "^assault offenses - simple assault$" = "violent",
  "^bribery$" = "other",
  "^burglary/breaking and entering$" = "property_financial",
  "^counterfeiting/forgery$" = "property_financial",
  "^destruction/damage/vandalism of property$" = "destruction_damage_vandalism",
  "^drug/narcotic offenses - drug equipment violations$" = "other",
  "^drug/narcotic offenses - drug/narcotic violations$" = "other",
  "^embezzlement$" = "property_financial",
  "^extortion/blackmail$" = "violent",
  "^fraud offenses - credit card/atm fraud$" = "property_financial",
  "^fraud offenses - false pretenses/swindle/confidence game$" = "property_financial",
  "^fraud offenses - impersonation$" = "property_financial",
  "^fraud offenses - other$" = "property_financial",
  "^fraud offenses - welfare fraud$" = "property_financial",
  "^fraud offenses - wire fraud$" = "property_financial",
  "^gambling offenses - betting/wagering$" = "other",
  "^human trafficking - commercial sex acts$" = "violent",
  "^human trafficking - involuntary servitude$" = "violent",
  "^kidnapping/abduction$" = "violent",
  "^larceny/theft offenses - all other larceny$" = "property_financial",
  "^larceny/theft offenses - other$" = "property_financial",
  "^larceny/theft offenses - pocket-picking$" = "property_financial",
  "^larceny/theft offenses - purse-snatching$" = "property_financial",
  "^larceny/theft offenses - shoplifting$" = "property_financial",
  "^larceny/theft offenses - theft from building$" = "property_financial",
  "^larceny/theft offenses - theft from motor vehicle$" = "property_financial",
  "^larceny/theft offenses - theft of motor vehicle parts/accessories$" = "property_financial",
  "^larceny/theft offenses - theft rom coin-operated machine or device$" = "property_financial",
  "^motor vehicle theft$" = "property_financial",
  "^murder/nonnegligent manslaughter$" = "violent",
  "^negligent manslaughter$" = "violent",
  "^pornography/obscene material$" = "other",
  "^prostitution offenses - assisting or promoting prostitution$" = "other",
  "^prostitution offenses - prostitution$" = "other",
  "^prostitution offenses - purchasing prostitution$" = "other",
  "^robbery$" = "violent",
  "^sex offenses - fondling - indecent liberties/child molest$" = "violent",
  "^sex offenses - incest$" = "violent",
  "^sex offenses - rape$" = "violent",
  "^sex offenses - sexual assault with an object$" = "violent",
  "^sex offenses - sodomy$" = "violent",
  "^sex offenses - statutory rape$" = "violent",
  "^stolen property offenses \\(receiving, selling, etc.\\)$" = "property_financial",
